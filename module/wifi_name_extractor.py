            ...
            try:
                ...
                try:
                    ...
                    if os.path.exists(airport_path):
                        result = subprocess.check_output([airport_path, "-I"], encoding="utf-8")
                ...
                try:
                    ...
                    for line in result.splitlines():
                        ...
                        if wifi_section and "SSID:" in line:
                            ssid = line.split(":", 1)[1].strip()
                            debug(f"Found SSID via system_profiler direct parsing: {ssid}")
                            return ssid
                except Exception as e:
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    cmd = "ifconfig en0 | grep status"
                    status = subprocess.check_output(cmd, shell=True, encoding="utf-8").strip()
                    ...
                    if "active" in status:
                        ...
                        print("this is due to macOS privacy protections. You may need to:")
                        print("1. Add Terminal/Python to Full Disk Access in System Preferences > Privacy")
            ...
            try:
                ...
                if "active" in status:
                    ...
                    print("This may be due to system privacy protections in newer macOS versions.")
